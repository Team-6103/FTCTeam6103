...
/*
* $Id: DIMC-driver.h 98 2012-08-04 09:02:53Z xander $
*/
...
*
* DIMC-driver.h provides an API for the Dexter Industries IMU Sensor.\n
*
* Changelog:
* - 0.1: Initial release
*
...
* \date 18 March 2012
* \version 0.1
* \example DIMC-test1.c
* \example DIMC-test2.c
* \example DIMC-test3.c
*/
...
int DIMCminVals[4][3] = {{65535, 65535, 65535}, {65535, 65535, 65535}, {65535, 65535, 65535}, {65535, 65535, 65535}};
...
bool DIMCinit(tSensors link)
{
  ...
  if (!writeI2C(link, DIMC_I2CRequest, 0))
    return false;
  ...
  return writeI2C(link, DIMC_I2CRequest, 0);
}
...
bool DIMCreadAxes(tSensors link, int &_x, int &_y, int &_z)
{
  ...
  if (!writeI2C(link, DIMC_I2CRequest, 6)) {
    writeDebugStreamLine("error write");
    return false;
  }

  if(!readI2C(link, DIMC_I2CReply, 6)) {
