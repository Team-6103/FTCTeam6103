...
/*
 * $Id: MSMMUX-driver.h 98 2012-08-04 09:02:53Z xander $
 */
 ...
 * @return true if no error occured, false if it did
 */
bool MSMMUXsetPID(tSensors link, int kpTacho, int kiTacho, int kdTacho, int kpSpeed, int kiSpeed, int kdSpeed, ubyte passCount, ubyte tolerance, ubyte address) {
  memset(MSMMUX_I2CRequest, 0, sizeof(tByteArray));
